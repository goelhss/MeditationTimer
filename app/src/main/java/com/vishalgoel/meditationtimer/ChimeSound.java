...
public enum ChimeSound {
    ...
    MEDITATION_BOWL("meditation_bowl", "Meditation Bowl · grounded & spacious", 4800,
            new double[] {174.6, 261.8, 349.9, 523.8, 698.8},
            new double[] {1.0, 0.7, 0.44, 0.25, 0.12},
            new double[] {3.25, 2.7, 2.1, 1.55, 1.1}, 245, 0.54),
