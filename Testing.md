...
- `TEST_SUITE=always`: package, manifest, timer/preparation/reminder math, preset and streak/statistics rules, cue-mode and synthesized-sound policy, completion policy, core log/resolution persistence-format tests, merge-with-dedup restore, and backup security-policy checks. Required before every build and push.
