...
- `TEST_SUITE=always`: package, manifest, timer/reminder math, cue-mode and synthesized-sound policy, completion policy, and core log persistence/format tests. Required before every build and push.
...
- `TEST_SUITE=ui`: required tabs, lotus launch screen, sound and timer-display dropdowns, digital/analog timer wiring, chime/vibration defaults and live switching, reminder scheduling/notification wiring, About/version history, What's New, dim-screen, and diagnostics source policies.
