...
- `TEST_SUITE=always`: package, manifest, timer math, completion policy, and core log persistence/format tests. Required before every build and push.
...
- `TEST_SUITE=ui`: required tabs, defaults, About/version history, What's New, dim-screen, and diagnostics source policies.
