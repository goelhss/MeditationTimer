...
- `TEST_SUITE=ui`: required tabs, lotus launch screen, sound and timer-display dropdowns, digital/analog timer wiring, chime/vibration defaults, reminder scheduling/notification wiring, About/version history, What's New, dim-screen, and diagnostics source policies.
