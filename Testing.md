...
- `TEST_SUITE=always`: package, manifest, timer/preparation/reminder math, cue-mode and synthesized-sound policy, completion policy, and core log/resolution persistence-format tests. Required before every build and push.
