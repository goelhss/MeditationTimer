...
A calm Android phone timer with digital/analog countdowns, resonant chime/vibration cues, reliable screen-locked operation, configurable local reminders, session logs, and text-file sharing.
